...
<img src='image/gov1.png'>
  ...
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
     ...
     Card No  :  <b><font color="red">*</font></b>    
      <input type="number" name="cardno" placeholder="xxxx xxxx xxxx xxxx" required><br><br>
     
     expiry  date: <b><font color="red">*</font></br>  
       <input type="date" name="expirym"  required></br>   
     
                                 
     
      I agree to pay:<input type="checkbox" name="money" value="₹1500" required></br></br>
      
      CVV[3 digit no]: <input type="password" name="cvv" placeholder="XXX" required></br></br>
