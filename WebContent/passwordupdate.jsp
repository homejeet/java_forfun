...
<title>Password Update |Indian passport portal</title>
...
, confirm_password = document.getElementById("pwd1");
...
<img src='image/gov1.png'>
  ...
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
    ...
    <div ng-app="">
      ...
      <input type="text" name="mobile" placeholder=""  id="pwd" ng-model="id"  required><br><br>
     New Password  :  <b><font color="red">*</font></b>    
      <input type="text" name="upassword" placeholder=""  id="pwd" ng-model="id"  required><br>
     
        <font color="green">Your password:</font> {{ id }}  </br></br>
     
    <!--  Confirm Password: <b><font color="red">*</font></b> 
       <input type="password" name="password"  id="pwd1"  required><br><br>
        -->
